...
<Callout type="info">
Uses the `fsdp` backend. See the [Vision-Language RL tutorial](../tutorials/vision_language_rl) for the VLM setup background (required flags and dataset record shape).
</Callout>
